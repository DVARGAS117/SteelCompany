...
$serie              = $fcons['serie'];
$num_comprobante    = $fcons['num_comprobante'];
$xSerie             = $fcons['serie'] . '-' . $fcons['num_comprobante'];
if ($codigo_compro == '01') {
    $documento      = "Factura";
}
if ($codigo_compro == '07') {
...
$estado             = $fcons['estado'];
$prefijo            = substr($fcons['serie'], 0, 2);
if (($codigo_compro == '01' or $codigo_compro == '07') and $prefijo == "FF") {
    $ruta_xml       = "archivos_xml_sunat/cpe_xml/beta/$xRucEmpresa/$xRucEmpresa-" . $codigo_compro . "-" . $serie . "-" . $num_comprobante . ".XML";
} else {
    $ruta_xml       = "";
}
?>
    ...
    <script>
        $(function() {
            $("#benviar").click(function() {
                $("#proceso").val("ActualizarEstadoFact");
                $("#modulo").val("FacturasElectronicas");
