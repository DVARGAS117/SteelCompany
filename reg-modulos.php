                ...
                <div class="card-body">
                    <form action="" name="fapps" id="fapps">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="nombre_modulo" id="nombre_modulo">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <button type="button" class="btn btn-success waves-effect waves-light" id="benviar">
                                    <i class="mdi mdi-content-save align-middle me-2"></i> REGISTRAR MODULO
                                </button>
            ...
            $("#benviar").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (respuesta == 'SI') {
                            alert("El modulo se registro con exito.");
                            location.reload();
                        } else {
