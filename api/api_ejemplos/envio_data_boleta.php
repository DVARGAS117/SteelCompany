...
$ruta = "$url/api_facturacion/boleta.php";
...
echo "<br /><br />url_xml	: http://localhost:82/Nueva%20carpeta/sistema%20api/".$response['url_xml'];
echo "<a href=http://localhost:82/Nueva%20carpeta/sistema%20api/".$response['url_xml']." download=xml>Descargar XML</a>";
echo "<br /><br />hash_cpe	: ".$response['hash_cpe'];
echo "<br /><br />hash_cdr	: ".$response['hash_cdr'];
echo "<br /><br />msj_sunat	: ".$response['msj_sunat'];
echo "<br /><br />ruta_cdr	: http://localhost:82/Nueva%20carpeta/sistema%20api/".$response['ruta_cdr'];
echo "<a href=http://localhost:82/Nueva%20carpeta/sistema%20api/".$response['ruta_cdr']." download=xml>Descargar CDR</a>";
