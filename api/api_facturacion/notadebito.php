<?php
	...
	$accion1=mysqli_query($con, "select * from empresa where ruc='$ruc'");
	...
	if ($tipo == '1') {
        ...
        //$ruta = $url_base . $content_folder_xml . 'produccion' .  "/" . $nombre_archivo;
        //$ruta_cdr = $url_base . $content_folder_xml . 'produccion' .  "/";
	...
	$ruta = $url_base . $content_folder_xml . 'beta/' . $array_emisor['ruc'] . "/" . $nombre_archivo;
        ...
        //$ruta = $url_base . $content_folder_xml . 'beta' .  "/" . $nombre_archivo;
        //$ruta_cdr = $url_base . $content_folder_xml . 'beta' .  "/";
	...
	//$resp['ruta_cdr'] = "";
        if($resp['respuesta']=="ok"){
           ...
           // cambiar
            ...
            //print"INSERT INTO documentos_electronicos VALUES (NULL,'$ruc','$respuesta','$url_xml','$hash_cpe','$hash_cdr','$msj_sunat','$ruta_cdr','$tipo','$doc','$cliente')";
            $insert=mysqli_query($con,"INSERT INTO documentos_electronicos VALUES (NULL,'$ruc','$respuesta','$url_xml','$hash_cpe','$hash_cdr','$msj_sunat','$ruta_cdr','$tipo1','$doc','$cliente','$tipo')");
        }
