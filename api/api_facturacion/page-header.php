<!-- Page header -->
	<div class="page-header page-header-inverse bg-indigo" style="background:#1C1C1C;">

		<!-- Main navbar -->
		<div class="navbar navbar-inverse navbar-transparent">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.php"><img src="assets/images/logo_light2.png" alt=""></a>
			...
			<div class="navbar-collapse collapse" id="navbar-mobile">
                            <p class="navbar-text"><span class="label bg-success-400"><a target="_blank" href="archivos_xml_sunat/cpe_xml/beta/20100066603/">Lista de documentos</a></span></p>

				<ul class="nav navbar-nav">
					<li><a target="_blank" href="api_ejemplos">Api ejemplos</a></li>
				</ul>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown dropdown-user">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								...
								<li><a target="_blanck" href="controllers/envio_data_factura.php"><i class="icon-cog5"></i> Factura Electronica</a></li>
								<li><a target="_blanck" href="controllers/envio_data_boleta.php"><i class="icon-cog5"></i> Boleta Electronica</a></li>
                                                                <li><a target="_blanck" href="controllers/envio_data_nota_credito.php"><i class="icon-cog5"></i> Nota de Credito Electronica</a></li>
                                                                <li><a target="_blanck" href="controllers/envio_data_nota_debito.php"><i class="icon-cog5"></i> Nota de debito Electronica</a></li>
                                                                <li><a target="_blanck" href="controllers/envio_data_baja_sunat.php"><i class="icon-cog5"></i> Documento de baja Electronica</a></li>
                                                                <li><a target="_blanck" href="controllers/envio_data_resumen_boletas.php"><i class="icon-cog5"></i> Resumen Boletas Electronica</a></li>
                                                                <li><a target="_blanck" href="controllers/envio_data_guia_remision.php"><i class="icon-cog5"></i> Guia remision Electronica</a></li>
		...
		<div class="page-header-content">
			<div class="page-title">
				<h4>API Facturación Electrónica <small>Sistema DEMO API de Facturación Electrónica</small></h4>
			</div>

			<div class="heading-elements">
				<ul class="breadcrumb heading-text">
					<li><a href="index.php"><i class="icon-home2 position-left"></i> Home</a></li>
					<li class="active">API Facturación Electrónica</li>
				</ul>
			</div>
		</div>
		<!-- /page header content -->
		...
		<div class="navbar navbar-inverse navbar-transparent" id="navbar-second">
			...
			<div class="navbar-collapse collapse" id="navbar-second-toggle">
				<ul class="nav navbar-nav navbar-nav-material">
					<li class="active"><a href="index.php">API Facturación Electrónica</a></li>
