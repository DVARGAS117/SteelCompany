...
$cod_motivo         = $_REQUEST['cod_motivo'];
$sqlConuslta        = mysqli_query($conexion, "SELECT * FROM motivo_nota_credito WHERE cod_motivo='$cod_motivo'");
$fcons              = mysqli_fetch_array($sqlConuslta);
$cod_motivo         = $fcons['cod_motivo'];
$codigo             = $fcons['codigo'];
            ...
            <div class="card">
                <div class="card-body">
                    <form action="" name="fapps" id="fapps">
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-3 col-form-label">Descripcion Nota Credido</label>
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="descripcion" id="descripcion" value="<?= $descripcion ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-3 col-form-label">Codigo Nota Credio</label>
                            <div class="col-md-9">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <button type="button" class="btn btn-success waves-effect waves-light" id="benviar">
                                    <i class="mdi mdi-content-save align-middle me-2"></i> ACTUALIZAR NOTA CREDITO
                                </button>
                                <input type="hidden" name="proceso" id="proceso">
                                <input type="hidden" name="modulo" id="modulo">
                                <input type="hidden" name="cod_motivo" id="cod_motivo" value="<?= $cod_motivo ?>">
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(function() {
            $("#benviar").click(function() {
                ...
                /*******************************************/
                /*******************************************/
                $("#proceso").val('ActualizarNotaCredito');
                $("#modulo").val('NotaCredito');
