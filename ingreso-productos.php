                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Administrar Ingresos</h4>
                                <!-- **************************************** -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $sqlConsulta            = mysqli_query($conexion, "SELECT * FROM ingreso_stock ORDER BY fecha_entrada DESC");
                                            while ($fconsul         = mysqli_fetch_array($sqlConsulta)) {
                                                $fecha_entrada      = date('d-m-Y', strtotime($fconsul['fecha_entrada']));
