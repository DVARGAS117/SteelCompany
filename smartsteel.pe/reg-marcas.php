                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <button type="button" class="btn btn-success waves-effect waves-light" id="benviar">
                                    <i class="mdi mdi-content-save align-middle me-2"></i> REGISTRAR MARCA
                                </button>
    ...
    <script>
        $(function() {
            $("#benviar").click(function() {
                if ($("#marca").val() == '') {
                    alert("Falta ingresar marca");
                    $("#marca").focus();
                    return false;
                }
                /*******************************************/
                /*******************************************/
                $("#proceso").val('RegistrarMarcas');
                $("#modulo").val('Marcas');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (respuesta == 'SI') {
                            alert("La marca se registro con exito.");
                            location.reload();
                        } else {
                            alert("Lo sentimos pero la marca ya existe.");
                        }
                    }
                })
            })
