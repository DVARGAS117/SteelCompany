                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Administrar Cargos para el Personal</h4>
                                <!-- **************************************** -->
                                <div class="page-title-right">
                                    <div class="button-items">
                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#bs-example-modal-xl" data-remote="reg-cargos.php" data-sb-backdrop="static" data-sb-keyboard="false">
                                            Añadir Cargos <i class="ri-folder-add-fill align-middle ms-2"></i>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $sqlConsulta            = mysqli_query($conexion, "SELECT * FROM cargos_personal");
                                            while ($fconsul         = mysqli_fetch_array($sqlConsulta)) {
                                                $cod_cargo          = $fconsul['cod_cargo'];
                                                $cargo              = $fconsul['cargo'];
                                                if ($fconsul['estado'] == 'A') {
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $estado ?></td>
                                                    <td>
                                                        <a href="#" class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#bs-example-modal-xl" data-remote="mod-cargos.php?cod_cargo=<?= $cod_cargo ?>" data-sb-backdrop="static" data-sb-keyboard="false">
                                                        ...
                                                        <a href="" class="btn btn-outline-danger btn-sm borrarReg">
                                                            ...
                                                            <input type="hidden" name="codborrar" value="<?= $cod_cargo ?>" class="codborrar">
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Registrar/Editar Cargos</h5>
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.borrarReg', function() {
                var cod_cargo = $('.codborrar', this).val();
                var datosEnviar = {
                    'cod_cargo': cod_cargo,
                    'modulo': "Cargos"
                }
