                ...
                <div class="card-body">
                    <form action="" name="fapps" id="fapps">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="codigo_compro" id="codigo_compro">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <button type="button" class="btn btn-success waves-effect waves-light" id="benviar">
                                    <i class="mdi mdi-content-save align-middle me-2"></i> REGISTRAR DOCUMENTO
                                </button>
    ...
    <script>
        $(function() {
            $("#benviar").click(function() {
                ...
                /*******************************************/
                /*******************************************/
                $("#proceso").val('RegistrarTipoDocumento');
