                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Enviar Facturas Electrónicas a Sunat</h4>
                                <!-- **************************************** -->
                                <div class="page-title-right">
                                    <div class="button-items">
                                        <a class="btn btn-danger waves-effect waves-light" onclick="javascript:consultaVCP()">
                                            Validar Facturas <i class="mdi mdi-check-network ms-2"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $critbus                = "FF";
                                            $sqlConsulta            = mysqli_query($conexion, "SELECT * FROM factura WHERE (codigo_compro='01' OR codigo_compro='07') AND (serie LIKE '%$critbus%') ORDER BY fecha_registro DESC");
                                            while ($fconsul         = mysqli_fetch_array($sqlConsulta)) {
                                                ...
                                                if ($fconsul['estado'] == 'Por Enviar') {
                                                    $estado         = "
                                                    <a href='#' class='badge rounded-pill bg-danger' data-bs-toggle='modal' data-bs-target='#bs-example-modal-xl' data-remote='enviar-facturas-notas-credito-sunat.php?id_factura=$id_factura' data-sb-backdrop='static' data-sb-keyboard='false'>
                                                        Enviar a Sunat Ahora <i class='ri-send-plane-fill align-middle ms-2'></i>
                                                    </a>";
                                                } else {
                                                    $estado         = "
                                                    <span class='badge rounded-pill bg-success'>
                                                        Factura Aceptada <i class='ri-check-line align-middle ms-2'></i>
                                                    </span>";
                                                }
                                                /***********************************************/
                                                $mum++;
