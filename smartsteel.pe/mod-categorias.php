...
$sqlConuslta        = mysqli_query($conexion, "SELECT * FROM categoria_productos WHERE cod_categoria='$cod_categoria'");
            ...
            <div class="card">
                <div class="card-body">
                    <form action="" name="fapps" id="fapps">
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-2 col-form-label">Categoria</label>
                            <div class="col-md-10">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <button type="button" class="btn btn-success waves-effect waves-light" id="benviar">
                                    <i class="mdi mdi-content-save align-middle me-2"></i> ACTUALIZAR CATEGORIA
                                </button>
    ...
    <script>
        $(function() {
            $("#benviar").click(function() {
                ...
                /*******************************************/
                /*******************************************/
                $("#proceso").val('ActualizarCategorias');
