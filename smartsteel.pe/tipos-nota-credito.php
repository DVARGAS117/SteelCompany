                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Administrar Tipos de Nota de Credito</h4>
                                <!-- **************************************** -->
                                <div class="page-title-right">
                                    <div class="button-items">
                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#bs-example-modal-xl" data-remote="reg-nota-credito.php" data-sb-backdrop="static" data-sb-keyboard="false">
                                            Nuevo Nota Credito <i class="ri-folder-add-fill align-middle ms-2"></i>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $sqlConsulta            = mysqli_query($conexion, "SELECT * FROM motivo_nota_credito");
                                            while ($fconsul         = mysqli_fetch_array($sqlConsulta)) {
                                                $cod_motivo         = $fconsul['cod_motivo'];
                                                $codigo             = $fconsul['codigo'];
                                                $descripcion        = $fconsul['descripcion'];
                                                if ($fconsul['estado'] == 'A') {
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $estado ?></td>
                                                    <td>
                                                        <a href="#" class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#bs-example-modal-xl" data-remote="mod-nota-credito.php?cod_motivo=<?= $cod_motivo ?>" data-sb-backdrop="static" data-sb-keyboard="false">
                                                        ...
                                                        <a href="" class="btn btn-outline-danger btn-sm borrarReg">
                                                            ...
                                                            <input type="hidden" name="codborrar" value="<?= $cod_motivo ?>" class="codborrar">
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.borrarReg', function() {
                var cod_motivo = $('.codborrar', this).val();
                var datosEnviar = {
                    'cod_motivo': cod_motivo,
                    'modulo': "TipoNotaCredito"
                }
