                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Administrar Salidas</h4>
                                <!-- **************************************** -->
                                <div class="page-title-right">
                                    <div class="button-items">
                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#bs-example-modal-xl" data-remote="salida-productos-tiendas.php" data-sb-backdrop="static" data-sb-keyboard="false">
                                            Salida Bloques <i class=" ri-cloud-fill align-middle ms-2"></i>
                                        </button>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#bs-example-modal-xl" data-remote="reg-salida-productos.php" data-sb-backdrop="static" data-sb-keyboard="false">
                                            Registrar Salida <i class="ri-folder-add-fill align-middle ms-2"></i>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $sqlConsulta            = mysqli_query($conexion, "SELECT * FROM salida_stock ORDER BY fecha_salida DESC");
                                            while ($fconsul         = mysqli_fetch_array($sqlConsulta)) {
                                                $fecha_salida       = date('d-m-Y', strtotime($fconsul['fecha_salida']));
                                                $cod_puntoventa     = $fconsul['cod_puntoventa'];
                                                $codigo             = $fconsul['codigo'];
                                                $nombre_producto    = $fconsul['nombre_producto'];
                                                $stock_salida       = $fconsul['stock_salida'];
                                                $archivo_csv        = $fconsul['archivo_csv'];
                                                /******************************************************/
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Salida Productos a Tiendas</h5>
