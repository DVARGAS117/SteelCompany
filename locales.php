                                ...
                                <div class="page-title-right">
                                    ...
                                    if ($accesoInsert == 'SI') {
                                        ...
                                        <div class="button-items">
                                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#bs-example-modal-xl" data-remote="reg-locales.php" data-sb-backdrop="static" data-sb-keyboard="false">
                                                Nuevo Local <i class="ri-folder-add-fill align-middle ms-2"></i>
                                            </button>
                                        </div>';
                                    }
                                    ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $sqlLocales             = mysqli_query($conexion, "SELECT * FROM puntos_ventas");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($accesoEdit == 'SI') {
                                                            echo '
                                                            <a href="#" class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#bs-example-modal-xl" data-remote="mod-locales.php?cod_puntoventa=' . $cod_puntoventa . '" data-sb-backdrop="static" data-sb-keyboard="false">
                                                        ...
                                                        if ($accesoElim == 'SI') {
                                                            ...
                                                            <a href="" class="btn btn-outline-danger btn-sm borrarReg">
                                                                ...
                                                                <input type="hidden" name="codborrar" value="' . $cod_puntoventa . '" class="codborrar">
                                                            </a>';
                                                        }
                                                        ?>
                                                    </td>
