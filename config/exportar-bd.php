 ...
 * $conexion = mysqli_connect('localhost', 'abelito_mag01yx', 'RTY$5452juotde12', 'abelito_xxNeo2030');
 */
define("DB_USER", 'abelito_mag01yx');
define("DB_PASSWORD", 'RTY$5452juotde12');
define("DB_NAME", 'abelito_xxNeo2030');
define("DB_HOST", 'localhost');
//define("BACKUP_DIR", 'backupdb'); // Comment this line to use same script's directory ('.')
    ...
    public function backupTables($tables = '*')
    {
        try {
            ...
            if ($this->gzipBackupFile) {
                ...
                $this->obfPrint('Exportación finalizo y se encuentra en : ' . $this->backupDir . '/' . $this->backupFile, 1, 1);
                $this->obfPrint('<a href=https://www.cursos-paginas-web.com/APPFACT2022/' . $this->backupDir . '/' . $this->backupFile . '>CLICK PARA DESCARGAR</a>', 1, 1);
            }
        } catch (Exception $e) {
            print_r($e->getMessage());
            return false;
...
if (php_sapi_name() != "cli") {
    echo '<div style="font-family: "Work Sans", sans-serif;">';
}
$backupDatabase = new Backup_Database(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME, CHARSET);
$result = $backupDatabase->backupTables(TABLES, BACKUP_DIR) ? 'OK' : 'KO';
$backupDatabase->obfPrint('Resultado de la Exportación : ' . $result, 1);
